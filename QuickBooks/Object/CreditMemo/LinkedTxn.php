 ...
 * 
 */
class QuickBooks_Object_CreditMemo_LinkedTxn extends QuickBooks_Object_Generic
{
	/**
	...
	/*
	 ...
	 LinkedTxn         1.1      0 - n   
  TxnID IDTYPE      1.0      1  
  TxnType ENUMTYPE      1.0      1  
  TxnDate DATETYPE      1.0      1  
  RefNumber STRTYPE  20 chars  21 chars  1.0      0 - 1  
  LinkType ENUMTYPE      3.0      0 - 1  
  Amount AMTTYPE      1.0      1  
