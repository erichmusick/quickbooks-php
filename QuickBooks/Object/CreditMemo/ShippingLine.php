...
/**
 * QuickBooks CreditMemo ShippingLine object class
 *
 * Derived from Keith's Invoice ShippingLine class
 * 
 ...
 * 
 */
class QuickBooks_Object_CreditMemo_ShippingLine extends QuickBooks_Object
{
	/**
